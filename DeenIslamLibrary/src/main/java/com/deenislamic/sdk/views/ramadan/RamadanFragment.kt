...
internal class RamadanFragment : BaseRegularFragment(),
    RamadanCallback,
    ...
    HorizontalCardListCallback
{
    ...
    override fun onCreateView(
        ...
        val mainview = localInflater.inflate(R.layout.fragment_ramadan,container,false)
    ...
    {
        ramadanPatchAdapter.updateFastingTrack(fasting)
    }
