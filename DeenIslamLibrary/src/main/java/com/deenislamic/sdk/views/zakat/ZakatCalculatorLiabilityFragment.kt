...
import com.deenislamic.sdk.databinding.FragmentZakatCalculatorLiabilityBinding
...
internal class ZakatCalculatorLiabilityFragment(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.inputPart1.heading.setTextColor(ContextCompat.getColor(requireContext(),R.color.deen_brand_error))
        ...
        binding.inputPart2.heading.setTextColor(ContextCompat.getColor(requireContext(),R.color.deen_brand_error))
