...
internal class PrayerLearningCatAdapter(private val data: List<Data>) : RecyclerView.Adapter<BaseViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder =
        ...
        {
            "cacl" -> ViewHolder(LayoutInflater.from(parent.context.getLocalContext()).inflate(R.layout.item_zakat_calc_btn,parent,false))
            "subs" -> ViewHolder(LayoutInflater.from(parent.context.getLocalContext()).inflate(R.layout.item_subs_cardview,parent,false))
            ...
            PATCH_COMMON_CARD_LIST -> {
                ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.layout_horizontal_listview_v2,parent,false))
            }
