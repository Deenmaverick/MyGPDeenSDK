...
internal class PremiumFeatureAdapter(private val premiumFeatures: List<com.deenislamic.sdk.service.network.response.subscription.PremiumFeature>) : RecyclerView.Adapter<BaseViewHolder>() {
