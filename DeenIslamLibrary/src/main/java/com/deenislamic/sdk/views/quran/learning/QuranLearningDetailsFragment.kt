...
import com.deenislamic.sdk.service.libs.media3.CustomTimeBar
...
import com.deenislamic.sdk.utils.DIGITAL_QURAN_CLASS_TC
import com.deenislamic.sdk.utils.PRODUCT_ID_QURAN_CLASS_350_TK
import com.deenislamic.sdk.utils.durationToSeconds
...
import com.deenislamic.sdk.views.adapters.quran.learning.QuranLearningCourseV2Adapter
import com.deenislamic.sdk.views.adapters.quran.learning.QuranUstadList
import com.deenislamic.sdk.views.base.BaseRegularFragment
import com.deenislamic.sdk.views.common.patch.SingleCardItemPatch
...
*/
                    ...
                    faqList.apply {
                        val faqlist: ArrayList<FaqList> = arrayListOf(
                            ...
                            FaqList(
                                question = "ডিজিটাল কোরআন ক্লাস কি শিখতে পারবেন?",
                                content = "ডিজিটাল কোরআন শিক্ষা কোর্সে ব্যবহারকারীরা আরবি বর্ণমালা, মৌলিক আরবি শব্দভান্ডার এবং ব্যাকরণের নিয়ম, কোরআনের লিপি কীভাবে পড়তে হয় এবং পবিত্র কোরআন তেলাওয়াতের সাথে সম্পর্কিত নিষেধাজ্ঞাগুলি শিখবে। অ্যাপের ব্যবহারকারীরা ভিডিও এবং কুইজ এর সমন্বিত একটি অনলাইন কোর্সে যা খুব সহজে অ্যাক্সেস করতে পারবেন যে কোন সময় যে কোন অবস্থান থেকে। এই কোর্সটি নিবেন বিশিষ্ট হাফেজ ক্বারী মোঃ রকিবুল ইসলাম।"
                            ),
                            FaqList(
