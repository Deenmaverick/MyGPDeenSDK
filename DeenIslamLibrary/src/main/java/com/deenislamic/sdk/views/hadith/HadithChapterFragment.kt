...
import com.deenislamic.sdk.views.adapters.hadith.HadithChapterAdapter
import com.deenislamic.sdk.views.adapters.hadith.HadithChapterCallback
...
internal class HadithChapterFragment : BaseRegularFragment(), HadithChapterCallback {
    ...
    private fun viewState(data: List<com.deenislamic.sdk.service.network.response.hadith.chapter.Data>)
    {
