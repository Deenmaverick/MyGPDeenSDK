...
internal class HajjAndUmrahHomePatchAdapter(private val patchData: List<com.deenislamic.sdk.service.network.response.dashboard.Data>) : RecyclerView.Adapter<BaseViewHolder>() {
