...
internal interface PrayerLearningResource {
    ...
    data class AllCat(val data: List<com.deenislamic.sdk.service.network.response.dashboard.Data>) :PrayerLearningResource
    ...
    data class AllCatOld(val data: List<Data>) :PrayerLearningResource
