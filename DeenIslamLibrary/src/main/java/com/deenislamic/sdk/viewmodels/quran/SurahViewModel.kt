...
import com.deenislamic.sdk.service.repository.quran.SurahRepository
...
internal class SurahViewModel (
    ...
    private fun processSurahList_quran_com(response: ApiResource<com.deenislamic.sdk.service.network.response.quran.qurannew.surah.SurahList?>)
    {
        when(response)
        {
            is ApiResource.Failure -> _surahlist.value = CommonResource.API_CALL_FAILED
